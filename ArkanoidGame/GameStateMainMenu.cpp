...
namespace ArkanoidGame
{
	void GameStateMainMenuData::Init()
	{
		...
		options.children.push_back(optionsInfiniteApplesItem);
		options.children.push_back(optionsWithAccelerationItem);
		...
		mainMenu.children.push_back(recordsItem);
		mainMenu.children.push_back(exitGameItem);
